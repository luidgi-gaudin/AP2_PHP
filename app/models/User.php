...
class User {
    ...
    public function __construct($id = '', $nom = '', $prenom = '', $dateNaissance = null, $username = '', $email = '', $emailConfirmed = false, $passwordHash = '', $twoFactorEnabled = false, $accessFailedCount = 0) {
        $this->id = $id;
        $this->nom = $nom;
        $this->prenom = $prenom;
    ...
    public function getDateNaissance(): DateTime {
        return $this->date_naissance_m;
    }

    public function setDateNaissance($date_naissance_m): void {
        $this->date_naissance_m = $date_naissance_m;
    }
    ...
    public function save(): ?string {
        ...
        if ($exists) {
            ...
            $sql = "UPDATE users SET Nom_m = :nom, Prenom_m = :prenom, Date_naissance_m = :date_naissance, 
                    UserName = :username, Email = :email, EmailConfirmed = :email_confirmed,
                    PasswordHash = :password_hash, TwoFactorEnabled = :two_factor_enabled,
                    AccessFailedCount = :access_failed_count WHERE Id = :id";
        } else {
            // Insert
            $sql = "INSERT INTO users (Id, Nom_m, Prenom_m, Date_naissance_m, UserName, Email, 
                    EmailConfirmed, PasswordHash, TwoFactorEnabled, AccessFailedCount) 
                    VALUES (:id, :nom, :prenom, :date_naissance, :username, :email, :email_confirmed,
